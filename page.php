...
<?php if(have_posts()) : ?>
  ...
  <!-- ajout attribut style à la section "page-header"
         pour lui ajouter une image de fond correspondant à la vignette de la page. si (if) bien sure, il y a une vignette -->
